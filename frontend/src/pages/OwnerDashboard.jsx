                                    ...
                                    <div key={booking.id || booking._id} className="booking-item">
                                        <div className="booking-info">
                                            ...
                                            <div className="renter-info">
                                                ...
                                                {/* Identity Verification Details for Owner */}
                                                {['APPROVED', 'ACTIVE', 'COMPLETED'].includes(booking.status) && (
                                                    <div className="verification-details-box">
                                                        <div className="verification-detail-item">
                                                            ...
                                                            <span><strong>Aadhaar:</strong> {booking.user?.aadhaarNumber || 'Not available'}</span>
                                                        </div>
                                                        <div className="verification-detail-item">
                                                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                                            ...
                                                            <span><strong>License:</strong> {booking.user?.drivingLicenseNumber || 'Not available'}</span>
                                                        </div>
                                                    </div>
                                                )}
                                            </div>
